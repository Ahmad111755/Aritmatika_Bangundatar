...
<form action="<?= base_url('/Aritmatika/hitungperkalian'); ?>" class="text-start">
    <div class="mb-3 row">
        <div class="col-sm-10 mb-5">
            <a href="<?= base_url('aritmatika/pengurangan');?>" type="button" class="btn btn-warning"><i class="bi bi-arrow-left-square"></i> Previous</a>                
            <a href="<?= base_url('aritmatika/pembagian');?>" type="button" class="btn btn-warning">Next <i class="bi bi-arrow-right-square"></i></a>
        </div>
        <div class="col-sm-10">
            <h3>Perkalian </h3>
        </div>
